...
<body id='formulaire'>
    ...
    <!-- <form action='' method="POST" class='container'>
        ...
        <div id="contenu">
            ...
            <label class="special3" for="compétences">Veuillez saisir 10 compétences séparées par un ";" (minimum 5 compétences/maximum 10 compétences) Ne pas rajouter de ";" après la dernière compétence !!!!</label>
            <br>
